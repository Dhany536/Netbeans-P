...
public class jenisfile extends FileFilter {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jenisfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
